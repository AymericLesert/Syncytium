...
- le mapping entier (D646–D672) en situation réelle : `source/` sur
  un schéma Cegid PMI, les règles, le mode `relative` ;
- la posture entrepôt (D180) : le taux de couverture, les rejets,
  la vue de migration (D666) ;
- la vérification de règles métiers (D307/D404) sur les données
  converties.
