...
/**
 * Handle a webix bar chart into a board
 */
GUI.Board.BoardChartBar = class extends GUI.Board.BoardChartMultiData {
    /**
     * constructor
    ...
    constructor( box, name, title, list, icons, showXAxis ) {
        super( box, name, "board_chart_bar", title, list, icons, GUI.Board.BoardChartMultiData.BAR, showXAxis );
    }
};
