...
namespace Syncytium.Web.Areas.Sample.Controllers
{
    /// <summary>
    /// Handle the stock controller
    /// </summary>
    public class SampleController : SyncytiumController
    {
        #region Logger
        ...
        /// </summary>
        protected override string MODULE => typeof(SampleController).Name;

        #endregion

        /// <summary>
        /// URL ~/Sample/Sample/Index
        /// </summary>
        /// <param name="moduleId"></param>
        /// <returns></returns>
        [RoleFilter(Module = ModuleRecord.EModule.Sample)]
        public ActionResult Index(int? moduleId)
        {
            Debug($"Get ~/Sample/Sample/Index({moduleId})");
        ...
        /// </summary>
        public SampleController(UserManager userContext) : base(userContext) { }
