...
using Syncytium.Core.Common.Server.Database.Provider;
...
namespace Syncytium.Core.Common.Server.Managers
{
    ...
    public static class ConfigurationManager
    {
        ...
        /// <summary>
        /// HTTP address root of the github
        /// </summary>
        public static string SETTING_HTTP_GITHUB = "Syncytium.HTTP.GitHub";
        ...
        /// </summary>
        public static Dictionary<string, DSDatabase> Schemas = new();
        ...
        /// </summary>
        public static Provider.EProvider DatabaseProvider
        {
            get
            {
                ...
                Provider.EProvider databaseTypeDefault = Provider.EProvider.Unknown;

                if (databaseType != null)
                {
                    if (databaseType.ToUpper().Equals(Provider.EProvider.Oracle.ToString().ToUpper()))
                        databaseTypeDefault = Provider.EProvider.Oracle;

                    if (databaseType.ToUpper().Equals(Provider.EProvider.SQLServer.ToString().ToUpper()))
                        databaseTypeDefault = Provider.EProvider.SQLServer;

                    if (databaseType.ToUpper().Equals(Provider.EProvider.Firebird.ToString().ToUpper()))
                        databaseTypeDefault = Provider.EProvider.Firebird;

                    if (databaseType.ToUpper().Equals(Provider.EProvider.MySQL.ToString().ToUpper()))
                        databaseTypeDefault = Provider.EProvider.MySQL;
                }

                // replace the database type by the true one (defined by the provider)

                if (ConnectionStrings?[CONNEXION_STRING] == null)
                    return Provider.EProvider.None;
        ...
        /// Http Root defined by the application
        /// </summary>
        private static string? _serverHttpGitHub = null;

        /// <summary>
        /// Retrieve the root http address of the application
        /// </summary>
        public static string ServerHttpGitHub
        {
            get
            {
        ...
        public static Dictionary<string, string?> Settings
        {
            get
            {
                ...
                if (!settings.ContainsKey(SETTING_HTTP_GITHUB))
                    settings[SETTING_HTTP_GITHUB] = ServerHttpGitHub;
